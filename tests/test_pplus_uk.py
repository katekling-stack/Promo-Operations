...
def test_pplus_uk_split_and_naming():
    ...
    assert "The Agency - Season 2 - 15 (Tier 2) - UK" in names
    assert "The Agency - Season 2 - 15 (Tier 2) (Pluto) - UK" in names
    assert "The Agency - Season 2 - Pause Ad (Tier 4) - UK" in names
...
def test_pplus_uk_line_ad_units_and_main_sgs():
    ...
    pplus_t4 = next(p for p in order.placements
                    if p.name == "The Agency - Season 2 - 15 (Tier 4) - UK")
    ...
    pluto_t4 = next(p for p in order.placements
                    if p.name == "The Agency - Season 2 - 15 (Tier 4) (Pluto) - UK")
