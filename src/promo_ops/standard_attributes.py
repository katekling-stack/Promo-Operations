...
DIMENSION_ATTRIBUTE_TYPE = {
    ...
    # NOTE: Pluto channels + categories are NOT standard attributes. They are
    # segments generated by naming convention ("SG: PlutoTV Channels/Promo Category:
    # ...") — see config/pluto.yaml and the targeting engine. Not mapped here.
}
