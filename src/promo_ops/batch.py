...
SHEET_COLUMNS: list[str] = [
    ...
    "Flight Start", "Flight End", "Language", "Season or Messaging", "Primary Trafficker", "Existing IO ID",
    ...
    "Kids Audience",
    "Video Domination", "Video Domination Targeting", "Takeover", "Scene Lift", "Standard",
    "Rating Restrictions",
